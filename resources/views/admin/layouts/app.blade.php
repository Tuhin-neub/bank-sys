...
<head>
    ...
    <title>Dashboard-{{ $shop_info ? $shop_info->shop_name : '' }}</title>

    {{-- <script src="{{ asset('all/admin/assets/js/libs/jquery-3.1.1.min.js')}}"></script> --}}

    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('all/website/assets/images/favicons/apple-touch-icon.png') }}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('all/website/assets/images/favicons/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('all/website/assets/images/favicons/favicon-16x16.png') }}" />
